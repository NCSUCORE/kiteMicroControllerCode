...
//  limit value of UART signal 
  starCMD = constrain(starCMD,1334,1666);
  portCMD = constrain(portCMD,1334,1666);
  elevatorCMD = constrain(elevatorCMD,1072,2072);
  rudderCMD = constrain(rudderCMD,1334,1666);
