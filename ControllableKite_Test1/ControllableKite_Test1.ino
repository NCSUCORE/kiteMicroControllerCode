...
//    servo_rudder.writeMicroseconds((100*num2 + 8000)/9);

     ang1 = (num1*334 + 89*1333 - 3340)/89;
     ang2 = (num2*334 + 89*1333 - 3340)/89;
     ang3 = (num3*334 + 89*1333 - 3340)/89;

     servo_starboard.writeMicroseconds(ang3);
     servo_port.writeMicroseconds(3000-ang3);
     servo_elevator.writeMicroseconds(ang1);
